...
const GreetingMessage: FC = () => {
  ...
  const text =
    'Если ты находишься в данном режиме - значит еще не до конца представляешь, чем может помочь тебе данное приложение. Ничего сверхествественного мы не написали. Это просто удобный сервис, помогающей тебе держать в одном месте информацию о своих клиентах с возможностью оценивать свой ежемесячный доход. Некий ToDo лист для фрилансера.'
